defmodule PhxwsWeb.TransporterVehicleView do
  ...
  def render("index.json", %{transporter_vehicles: transporter_vehicles}) do
    %{data: render_many(transporter_vehicles, TransporterVehicleView, "transporter_vehicle.json")}
  end
